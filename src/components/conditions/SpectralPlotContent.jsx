...
const SpectralPlotContent = ({ data, multipleSpectra = null, selectedTintIndex = null }) => {
    ...
    const chartData = useMemo(() => {
        console.log('SpectralPlotContent: Processing data', { data, multipleSpectra, hasData: !!data, dataKeys: data ? Object.keys(data) : [] });
        ...
        if (multipleSpectra && Array.isArray(multipleSpectra)) {
            ...
            console.log('SpectralPlotContent: Processing single spectrum', { sampleEntries: Object.entries(data).slice(0, 5) });
            ...
            const result = Object.entries(data)
                .map(([wavelength, value]) => {
                    ...
                    if (isNaN(wl) || isNaN(refl)) {
                        console.warn('SpectralPlotContent: Invalid data point', { wavelength, value, parsedWl: wl, parsedRefl: refl });
                        return null;
                    }
                    return {
                        wavelength: wl,
            ...
            console.log('SpectralPlotContent: Processed result', { 
        ...
        console.log('SpectralPlotContent: No valid data found');
        return [];
    ...
    return (
        <div className="h-full flex flex-col">
            <div className="flex flex-row items-center justify-between space-y-0 pb-3 h-16 flex-shrink-0 px-6 pt-6">
                <h3 className="text-lg font-semibold">Spectral Data</h3>
            ...
            <div className="flex-1 p-1 overflow-hidden">
                {!hasAnyValues && !lastNonEmptyDataRef.current ? (
                    // Empty state when no data is available
                    <div className="h-full w-full min-h-[300px] flex items-center justify-center border-2 border-dashed border-gray-300 rounded-md">
                        <div className="text-center text-gray-500">
                            <div className="text-lg mb-2">No spectral data</div>
                            <div className="text-sm">Import measurement data to view spectral plot</div>
                        </div>
                    </div>
                ) : viewMode === 'plot' ? (
                    ...
                    // Spectral List View
                    <div className="h-full max-h-[300px] border rounded-md bg-background overflow-hidden">
                        {tableData.length > 0 ? (
                            ...
                            <div className="h-full flex items-center justify-center">
                                <div className="text-center text-gray-500">
                                    <div className="text-lg mb-2">No spectral data</div>
                                    <div className="text-sm">Import measurement data to view spectral values</div>
                                </div>
                            </div>
                        )}
                    </div>
...
export default memo(SpectralPlotContent);