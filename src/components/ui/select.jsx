...
const SelectTrigger = React.forwardRef(({ className, children, variant = "default", ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      variant === "default" && "focus:ring-2 focus:ring-ring focus:ring-offset-2",
      variant === "no-focus" && "focus:ring-0",
      className
    )}
    {...props}>
    {children}
